...
import sangokushi.data.GameMessage;
...
public final class OptionPanel extends JPanel {
    ...
    {//GEN-HEADEREND:event_startButtonActionPerformed
        ...
        int choice = JOptionPane.showOptionDialog(this, "开始游戏吗？", "三国志", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[1]);
        if (choice == 0) {
            JOptionPane.showMessageDialog(this, "    251年 英雄集结 " + playerName, "开始游戏", JOptionPane.PLAIN_MESSAGE);
            MainFrame.gamePanel.initGamePanel();
