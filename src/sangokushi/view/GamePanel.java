...
public class GamePanel extends JPanel {
    ...
    private void battleButtonClicked() {
        MainFrame.prepareBattlePanel.init();
        MainFrame.prepareBattlePanel.setVisible(true);
        this.setVisible(false);
    }
    
    private void buildButtonClicked() {
        MainFrame.buildingsPanel.updateData();
        MainFrame.buildingsPanel.setVisible(true);
        this.setVisible(false);
    }
