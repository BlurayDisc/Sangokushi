...
import sangokushi.old.BattleOld;
 ...
 * @author RuN
 */
public class BattlePanelOld extends javax.swing.JPanel
{
    private final BattleScreen bs;
    private final GamePanel gp;
    private BattleOld battle1, battle2, battle3, battle4;
    ...
    /**
     * Creates new form BattleOld
     */
    public BattlePanelOld(GamePanel gp, City currentCity, City attackingCity, Army northLegion, Army southLegion, Army westLegion, Army eastLegion)
    {
        super();
        setSize(800, 600);
        this.gp = gp;
    ...
    private void initBattles()
    {
        ...
        // AI.createLegions();
        // battle1 = new BattleOld(northLegion, AI.getNorthLegion);
        battle1 = new BattleOld(this.northLegion, this.southLegion);
